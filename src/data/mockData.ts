...
export const INITIAL_KPIS: KPI[] = [
  ...
  },
  {
    ...
    trend: 'stable',
    status: 'Red',
    description: 'Valorisation financière en Kilo Dinars Tunisiens de la production réelle conformée.',
  ...
  {
    id: 'kpi-cost-poids-dechet',
    category: 'Coût',
    name: 'Poids de déchet',
    unit: 'kg',
    dailyValue: 0,
    weeklyValue: 0,
    target: 3,
    trend: 'stable',
    status: 'Red',
    description: 'Poids total des rebuts et déchets générés par la production de l\'usine.',
    greenThreshold: '<= 3',
    owner: 'Directeur Compta&contrôle de gestion',
    site1Checked: true,
    site2Checked: true,
  ...
  },
  {
    ...
    trend: 'stable',
    status: 'Red',
    description: 'Poids total de matière première consommée par la production de l\'usine.',
    greenThreshold: '>= 280',
    owner: 'Directeur Compta&contrôle de gestion',
    site1Checked: true,
    site2Checked: true,
  ...
  },
  {
    ...
    trend: 'stable',
    status: 'Red',
    description: 'Taux de déchet calculé automatiquement par le rapport du poids de déchet sur le poids consommé.',
    greenThreshold: '<= 1.0',
    owner: 'Directeur Compta&contrôle de gestion',
    site1Checked: true,
    site2Checked: true,
  ...
  {
    id: 'kpi-cost-stock-dc2',
    category: 'Coût',
    name: 'Valeur Stock DC2',
    unit: 'KTnd',
    dailyValue: 0,
    weeklyValue: 0,
    target: 0,
    trend: 'stable',
    status: 'Red',
    description: 'Valorisation financière du stock DC2.',
    greenThreshold: '>= 0',
    owner: 'Directeur Compta&contrôle de gestion',
    site1Checked: false,
    site2Checked: false,
  ...
  },
  {
    ...
    trend: 'stable',
    status: 'Red',
    description: 'Valorisation financière du stock PMP.',
    greenThreshold: '>= 0',
    owner: 'Directeur Compta&contrôle de gestion',
    site1Checked: false,
    site2Checked: false,
  ...
  {
    id: 'kpi-cost-stock-dm2',
    category: 'Coût',
    name: 'Valeur Stock DM2',
    unit: 'KTnd',
    dailyValue: 0,
    weeklyValue: 0,
    target: 0,
    trend: 'stable',
    status: 'Red',
    description: 'Valorisation financière du stock DM2.',
    greenThreshold: '>= 0',
    owner: 'Directeur Compta&contrôle de gestion',
    site1Checked: false,
    site2Checked: false,
